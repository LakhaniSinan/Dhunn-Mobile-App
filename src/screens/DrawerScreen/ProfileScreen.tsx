...
import { Header,Button, Typography } from "../../components/atoms";
...
export const updateProfile = async ({ full_name, phone, imageUri,token,email,dob,gender }: UpdateProfilePayload) => {
  ...
  const handleImagePick = () => {
   ...
   const handleUpdateProfile = async () => {
      ...
      try {
        ...
        console.log(error);
        ToastAndroid.show('Profile update failed,, Try again', ToastAndroid.SHORT);
      } finally {
        setLoading(false);
      }
    };
